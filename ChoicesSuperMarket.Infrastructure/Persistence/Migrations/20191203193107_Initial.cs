        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DiscountOnUnit = table.Column<int>(nullable: false),
                    FreeUnit = table.Column<int>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SubCategoryDiscounts", x => x.Id);
                    table.ForeignKey(
                        name: "FK_SubCategoryDiscounts_SubCategories_SubCategoryId",
                        column: x => x.SubCategoryId,
                        principalTable: "SubCategories",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SubCategoryDiscounts_SubCategoryId",
                table: "SubCategoryDiscounts",
                column: "SubCategoryId",
                unique: true);
        }
